...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings','business_tag','event_user','guidebook_tip','oauth_access_tokens','oauth_auth_codes','oauth_clients','oauth_personal_access_clients','oauth_refresh_tokens','permission_role','site_voucher','tip_user','user_roles'],
        ],
    ...
    */
    ...
    'dashboard' => [
        ...
        'widgets' => [
          ...
          'App\\Widgets\\SubCategories',
          'App\\Widgets\\Keywords',
        ],
